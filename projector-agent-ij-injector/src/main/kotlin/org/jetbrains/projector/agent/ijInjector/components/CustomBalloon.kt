...
public class CustomBalloon(private val myTarget: Component) {

  public fun activateIfNeeded() {
    val owner = javax.swing.SwingUtilities.getWindowAncestor(myTarget);
  //
  //  owner.addComponentListener(myOwnerListener = new org.jetbrains.projector.agent.ijInjector.components.HwComponentAdapter(myTarget, this));
  //  myHwFacade = new javax.swing.JWindow(owner);
  //
  //  javax.swing.JPanel root = new org.jetbrains.projector.agent.ijInjector.components.HwJPanel(this);
